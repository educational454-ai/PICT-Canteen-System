              ...
              <div className="bg-white rounded-2xl border shadow-sm flex-1 overflow-y-auto overflow-x-auto relative">
                <table className="w-full text-left border-collapse min-w-[700px]">
                  <thead className="bg-white/95 backdrop-blur-sm border-b border-gray-100 text-[10px] font-bold text-gray-400 uppercase tracking-widest sticky top-0 z-10 shadow-sm">
                    <tr><th className="p-4 pl-6 md:pl-8">Faculty Details</th><th className="p-4 text-center">Year Scope</th><th className="p-4 text-center">Access Code</th><th className="p-4 text-center">Validity Period</th><th className="p-4 text-center pr-6 md:pr-8">Actions</th></tr>
                  </thead>
                  <tbody className="divide-y divide-gray-50 text-sm">
                    {filteredFaculty.map((f) => (
                      <tr key={f._id} className="hover:bg-gray-50/50 transition-all group">
                        <td className="p-4 pl-6 md:pl-8"><p className="font-bold text-gray-800 text-sm mb-0.5">{f.fullName}</p><p className="text-[11px] text-gray-400 font-medium">{f.email} • {f.mobile}</p></td>
                        ...
                        <td className="p-4 pr-6 md:pr-8 flex justify-center gap-3">
